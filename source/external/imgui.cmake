...
#  GIT_TAG v0.13 # Specify a specific commit or tag if needed
#)
...
add_custom_command(
    ...
    COMMAND python ${CMAKE_SOURCE_DIR}/source/external/patch_ImGuizmo.py ${ImGuizmo_SOURCE_DIR}/GraphEditor.cpp
    COMMENT "Applying patches to ImGuizmo/GraphEditor.cpp"
)

target_compile_definitions(ImGuizmo PRIVATE IMGUI_DEFINE_MATH_OPERATORS) # triggers a warning but wont work otherwise
