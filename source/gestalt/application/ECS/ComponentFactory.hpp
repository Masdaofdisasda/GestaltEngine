...
namespace gestalt::application {
    ...
    public:
      ...
      std::pair<Entity, NodeComponent*> create_entity(std::string node_name = "",
      ...
      void create_animation_component(
      ...
      Entity add_free_fly_camera(const glm::vec3& position, const glm::vec3& direction,
                                 ...
                                 PerspectiveProjectionComponent projection
                                 = PerspectiveProjectionComponent(kDefaultFov, 0.1f, 1000.f)) const;

      Entity add_animation_camera(const glm::vec3& position, const glm::quat& orientation,
                                  Entity entity,
                                  PerspectiveProjectionComponent projection
                                  = PerspectiveProjectionComponent(kDefaultFov, 0.1f,
                                                                   1000.f)) const;
      ...
      Entity add_free_fly_camera(const glm::vec3& position, const glm::vec3& direction,
                                 const glm::vec3& up, Entity entity,
                                 OrthographicProjectionComponent projection) const;

      Entity add_animation_camera(const glm::vec3& position, const glm::quat& orientation,
                                  Entity entity, OrthographicProjectionComponent projection) const;
