...
namespace gestalt {
  namespace graphics {
    ...
    public:
      ...
      void create_color_frame_buffer(const VkExtent3D& extent,
                                     std::shared_ptr<TextureHandle>& color_image) const;
      void create_depth_frame_buffer(const VkExtent3D& extent,
                                     std::shared_ptr<TextureHandle>& depth_image) const;
