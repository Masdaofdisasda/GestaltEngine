...
void ApplicationGui::init(Gpu& gpu, ApplicationWindow& window,
                     const std::shared_ptr<VkSwapchain>& swapchain,
...
void ApplicationGui::draw(VkCommandBuffer cmd, VkImageView target_image_view) {
...
void ApplicationGui::update(const SDL_Event& e) {
  ImGui_ImplSDL2_ProcessEvent(&e);
}

void ApplicationGui::guizmo() {
  ImGuizmo::BeginFrame();
...
void ApplicationGui::check_file_dialog() {
...
void ApplicationGui::scene_graph() {
...
void ApplicationGui::light_adaptation_settings() {
...
void ApplicationGui::sky_settings() {
...
void ApplicationGui::grid_settings() {
  if (ImGui::Begin("Sky & Atmosphere")) {
...
void ApplicationGui::shading_settings() {
...
void ApplicationGui::tone_map_settings() {
  RenderConfig& config = actions_.get_render_config();
...
void ApplicationGui::display_scene_hierarchy(const entity entity) {
...
void ApplicationGui::show_transform_component(NodeComponent& node, TransformComponent& transform) {
...
void ApplicationGui::show_mesh_component(MeshComponent& mesh_component) {
...
void ApplicationGui::show_light_component(LightComponent& light, TransformComponent& transform) {
...
void ApplicationGui::show_node_component() {
...
void ApplicationGui::show_scene_hierarchy_window() {
