...
class RenderPass {
public:
  void init(const Gpu& gpu, const std::shared_ptr<ResourceManager>& resource_manager, const std::shared_ptr<RenderResourceRegistry>& registry, const std::shared_ptr<Repository>& repository) {
    gpu_ = gpu;
...
class FrameGraph {
  ...
  std::shared_ptr<ResourceManager> resource_manager_;
  std::shared_ptr<Repository> repository_;
  std::shared_ptr<ApplicationGui> imgui_;
  ...
  ApplicationWindow& get_window() { return window_; }
...
public:
  ...
  void init(const Gpu& gpu, const ApplicationWindow& window,
            const std::shared_ptr<ResourceManager>& resource_manager,
      const std::shared_ptr<Repository>& repository, const std::shared_ptr<ApplicationGui>&
            imgui_gui);
