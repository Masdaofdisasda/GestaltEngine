...
class BrightPass final : public RenderPass {
  ...
  ShaderPassDependencyInfo deps_ = {.read_resources = {{std::make_shared<ColorImageResource>("scene_ssao", 1.0f)}},
...
class BloomBlurPass final : public RenderPass {
  ...
  ShaderPassDependencyInfo deps_ = {
      ...
      .write_resources = {{"scene_bloom",
                           std::make_shared<ColorImageResource>("scene_brightness_filtered", extent_)},
...
class StreaksPass final : public RenderPass {
  ...
  ShaderPassDependencyInfo deps_
      = {.read_resources = {{std::make_shared<ColorImageResource>("scene_bloom", extent_)}},
         .write_resources
         = {{"scene_streak", std::make_shared<ColorImageResource>("bloom_blurred_intermediate", 1.0f)}}};
...
class LuminanceDownscalePass final : public RenderPass {
  ...
  ShaderPassDependencyInfo deps_
      = {.read_resources
         = {{std::make_shared<ColorImageResource>("lum_64_final", extent64_)}},
         .write_resources
...
class LightAdaptationPass final : public RenderPass {
  ...
  ShaderPassDependencyInfo deps_
      = {.read_resources
         = {{std::make_shared<ColorImageResource>("lum_1_final", extent1_)}},
         .write_resources
...
class TonemapPass final : public RenderPass {
  ...
  ShaderPassDependencyInfo deps_
      = {.read_resources = {{std::make_shared<ColorImageResource>("scene_streak", extent_)},
