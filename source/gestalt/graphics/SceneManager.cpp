...
void SceneManager::init(const Gpu& gpu,
...
void SceneManager::create_entities(std::vector<fastgltf::Node> nodes, const size_t& mesh_offset) {
...
void SceneManager::build_hierarchy(std::vector<fastgltf::Node> nodes, const size_t& node_offset) {
...
void SceneManager::build_scene_graph(const std::vector<fastgltf::Node>& nodes, const size_t& mesh_offset) {
...
entity ComponentArchetypeFactory::create_entity() {
...
void ComponentArchetypeFactory::add_mesh_component(const entity entity, const size_t mesh_index) {
...
entity ComponentArchetypeFactory::create_spot_light(const glm::vec3& color, const float intensity,
...
void SceneManager::request_scene(const std::string& path) {
  scene_path_ = path;
}

void ComponentArchetypeFactory::init(const std::shared_ptr<ResourceManager>& resource_manager,
                                       const std::shared_ptr<Repository>& repository) {
  resource_manager_ = resource_manager;
  repository_ = repository;
