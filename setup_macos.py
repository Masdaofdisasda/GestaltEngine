...
def create_clion_build(build_dir, cmake_path='..', generator='Unix Makefiles', config_file='config.ini', format_target='fix-format'):
    """
    Creates a build directory, generates Unix Makefiles for CLion, and formats the code.
    ...
    # Example: cmake '..' -G 'Unix Makefiles' -DCMAKE_TOOLCHAIN_FILE='path_to_vcpkg_toolchain'
    cmake_command = [
        'cmake',
        cmake_path,
        '-G', generator,
...
if __name__ == '__main__':
    ...
    create_clion_build(build_directory)
