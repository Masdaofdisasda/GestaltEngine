...
namespace gestalt {
  namespace vkinit {
    //> init_cmd
    VkCommandPoolCreateInfo command_pool_create_info(VkCommandPoolCreateFlags flags = 0);
    ...
    VkRenderingAttachmentInfo depth_attachment_info(VkImageView view, VkClearValue* clear = nullptr,
                                                    VkImageLayout layout
                                                    = VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL);
    ...
    VkImageCreateInfo image_create_info(VkFormat format, VkImageUsageFlags usageFlags,
                                        VkExtent3D extent);
    VkImageCreateInfo cubemap_create_info(VkFormat format, VkImageUsageFlags usageFlags,
                                          VkExtent3D extent);
